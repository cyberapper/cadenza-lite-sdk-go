...
func TestMarketOrderbookGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Market.Orderbook.Get(context.TODO(), cadenzalite.MarketOrderbookGetParams{
		ExchangeType: cadenzalite.F(cadenzalite.MarketOrderbookGetParamsExchangeTypeBinance),
