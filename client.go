...
// environment (CADENZA_CLIENT_SDK_BEARER_TOKEN). The option passed in as arguments
...
func NewClient(opts ...option.RequestOption) (r *Client) {
	defaults := []option.RequestOption{option.WithEnvironmentProd()}
	if o, ok := os.LookupEnv("CADENZA_CLIENT_SDK_BEARER_TOKEN"); ok {
