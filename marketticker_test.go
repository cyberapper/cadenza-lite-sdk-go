...
func TestMarketTickerGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Market.Ticker.Get(context.TODO(), cadenzalite.MarketTickerGetParams{
		Symbol:       cadenzalite.F("BTC/USDT"),
		ExchangeType: cadenzalite.F(cadenzalite.MarketTickerGetParamsExchangeTypeBinance),
	})
	if err != nil {
