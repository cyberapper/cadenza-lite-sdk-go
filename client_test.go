...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Clients.Info.Get(context.Background())
	if userAgent != fmt.Sprintf("Cadenza/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.Clients.Info.Get(context.Background())
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.Clients.Info.Get(cancelCtx)
	if err == nil || res != nil {
		t.Error("Expected there to be a cancel error and for the response to be nil")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.Clients.Info.Get(deadlineCtx)
		if err == nil || res != nil {
