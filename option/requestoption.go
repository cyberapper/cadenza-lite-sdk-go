...
// RequestOption is an option for the requests made by the cadenza API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/cyberapper/cadenza-lite-sdk-go#readme-requestoptions
...
func WithEnvironmentUat() RequestOption {
	return WithBaseURL("https://cadenza-lite.uat.algo724.com/")
}
