...
func TestExchangeAccountNew(t *testing.T) {
	...
	_, err := client.ExchangeAccount.New(context.TODO(), cadenzasdk.ExchangeAccountNewParams{
...
func TestExchangeAccountUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.ExchangeAccount.Update(context.TODO(), cadenzasdk.ExchangeAccountUpdateParams{
...
func TestExchangeAccountList(t *testing.T) {
	...
	_, err := client.ExchangeAccount.List(context.TODO())
	if err != nil {
		var apierr *cadenzasdk.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestExchangeAccountRemove(t *testing.T) {
	...
	_, err := client.ExchangeAccount.Remove(context.TODO(), cadenzasdk.ExchangeAccountRemoveParams{
		ExchangeAccountID: cadenzasdk.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
	})
	if err != nil {
		var apierr *cadenzasdk.Error
...
func TestExchangeAccountSetExchangePriority(t *testing.T) {
	...
	_, err := client.ExchangeAccount.SetExchangePriority(context.TODO(), cadenzasdk.ExchangeAccountSetExchangePriorityParams{
